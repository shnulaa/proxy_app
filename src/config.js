...
let config = {
    ...
    serverName: 'google.shnulaa.xyz',
}

let { httpprefix, serverName, port } = config
...
module.exports = { httpprefix, serverName, port, locationReplaceMap302, regReplaceMap, siteSpecificReplace, pathReplace }
